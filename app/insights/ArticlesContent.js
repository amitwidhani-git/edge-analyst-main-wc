...
const ARTICLES = [
  ...
  },  
  {
    ...
    excerpt2:`Campaz came on as a substitute in extra time and had the chance to win it in the final seconds — a one-on-one with Kobel that he somehow dragged wide. The moment that will define Colombia's tournament. Penalties followed. Kobel saved from Córdoba and Ríos — two crucial stops that gave Switzerland the margin they needed. Akanji, Ndoye, Embolo and Xhaka all converted. Quintero and Díaz scored for Colombia but it wasn't enough. Switzerland won their first ever World Cup penalty shootout.`,
    excerpt3:`The model gave Colombia 80.7% — wrong, in the most brutal possible fashion. Switzerland advance to face Argentina in the quarter-finals in Miami. Colombia exit having conceded just one goal in five matches, created chance after chance in this game, and ultimately been beaten by a goalkeeper and a missed penalty. Kobel. Campaz's miss. The tournament's cruelest exit. Switzerland face Messi and Argentina. Everyone is writing them off. Everyone wrote them off against Algeria too.`,
    stat:`80.7%`, statLabel:`Colombia win prob`, stat2:`0–0 (4–3 pens)`, statLabel2:`Final score`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: true,
  },  
  {
    tag:`Match Report`, date:`7 Jul 2026`,
    title:`Argentina 3–2 Egypt: 0–2 Down With 11 Minutes Left. Messi 21. Fernández in Stoppage Time. Champions Do Champion Things.`,
    excerpt:`Yasser Ibrahim headed Egypt ahead in the 15th minute. Messi had a penalty saved by Shobeir in the 21st. Shobeir saved from Mac Allister. Shobeir saved from Álvarez. Argentina's 19 first-half shots produced zero goals against a goalkeeper playing the game of his life. Mostafa Zico put Egypt 2–0 up in the 67th minute and the Hard Rock Stadium fell into stunned silence. The model gave Argentina 98.9%. They were losing 2–0 with 11 minutes left. Football.`,
    excerpt2:`Romero headed in from Messi's cross in the 79th minute. Messi scored himself four minutes later, rifling in a first-time strike to equalise — his 21st World Cup goal, the record extending further into unreachable territory. Then Enzo Fernández headed home from a Lautaro Martínez cross in the 90th+2 to complete the most dramatic comeback of the tournament. Three goals in 13 minutes from a side that had been staring at elimination. Egypt's players collapsed on the pitch. Argentina's bench was on the field before the final whistle.`,
    excerpt3:`The model gave Argentina 98.9% — correct on the outcome, completely blind to the story. An xG of 4.4 to 0.18 said Argentina would win this comfortably. They nearly didn't win it at all. Messi has now scored eight goals at this tournament — the most of any player — and has scored in a record eight consecutive World Cup matches. Argentina face the winner of Switzerland vs Colombia in Miami. The defending champions are through. Barely. Again. Nobody is knocking them out. Maybe nobody can.`,
    stat:`98.9%`, statLabel:`Argentina win prob`, stat2:`3–2`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
  ...
  },  
  {
    ...
    excerpt2:`Spain were excellent throughout — Rodri and Pedri immaculate in midfield, Yamal causing problems whenever he received the ball, Oyarzabal missing a one-on-one that should have settled it. Diogo Costa made five saves, including a stunning double stop from Yamal and Baena in the first half. Nuno Mendes hit the crossbar. Bernardo Silva headed over with the goal gaping. Then Ferran Torres received the ball deep and slid it to Merino, arriving late at the near post. First minute of stoppage time. 1–0. Spain through.`,
    excerpt3:`The model gave Spain 78.3% — correct, a 174-point Elo gap fully justified by a performance where Spain out-chanced Portugal almost 3-to-1 on xG. Spain have now kept a clean sheet in all six matches of this tournament — the first team to do so through the round of 16 since Italy in 1990. They face either USA or Belgium in the quarter-finals. For Ronaldo, the end. Six World Cups. First in 2006, when Portugal finished fourth. The last in 2026, at 41 years old, eliminated in stoppage time at SoFi Stadium. He deserved a better ending. Most of them do.`,
    stat:`78.3%`, statLabel:`Spain win prob`, stat2:`0–1`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: false,
  },  
  {
    tag:`Match Report`, date:`6 Jul 2026`,
  ...
  },  
  {
    ...
    excerpt2:`Désiré Doué was brought down in the box in the 68th minute — the VAR review confirming what the Philadelphia crowd had screamed for — and Mbappé stepped up, leaned left, sent Gill the wrong way, and rolled it into the bottom right corner. France's quality in the final third was relentless throughout. Barcola, Olise, Dembélé all creating. Paraguay's Galarza was lucky to avoid multiple yellow cards. But Gill kept them alive until the penalty. Mbappé now has seven goals at this tournament — level with Messi's six — and 19 World Cup goals in total, just one behind Messi's all-time record of 20.`,
    excerpt3:`The model gave France 97.9% — correct, and the performance justified every percentage point of it. France outscored their opponents 14-2 across the tournament so far — the most dominant attacking record of any side remaining. Morocco await in Boston on July 9 — AFCON champions, unbeaten in 33 matches, the Atlas Lions who just demolished Canada 3-0. For Paraguay, this was the end of one of the great tournament stories — the side that lost 4-1 to USA in the group stage, beat Germany on penalties, and gave the best team in the world one of their most difficult nights of the tournament. Gill will be remembered.`,
    stat:`97.9%`, statLabel:`France win prob`, stat2:`0–1`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: false,
  },  
  {
    tag:`Match Report`, date:`4 Jul 2026`,
    title:`Canada 0–3 Morocco: Ounahi's Brace. Bounou Returns to Houston. The Co-Hosts Are Out.`,
    excerpt:`Canada started the better side. Jonathan David forced Yassine Bounou — born in Montreal, raised in Casablanca — into a fine early save from a corner. Tani Oluwaseyi burst into the penalty area and fired straight at the goalkeeper's legs. Eustáquio's set-piece deliveries were causing Morocco genuine problems. For 50 minutes Canada were the team more likely to score. Then Hakimi rolled a free-kick to the edge of the area and Azzedine Ounahi swept a low shot into the bottom corner. Everything changed in an instant.`,
    excerpt2:`Saibari — recently transferred to Bayern Munich — went off injured in the 22nd minute, replaced by Rahimi, who hit the crossbar before Canada's hopes were definitively ended. Ounahi's second in the 82nd minute came from a swift Brahim Díaz pass on the counter; Rahimi's third in stoppage time was another breakaway, Díaz recording a fourth World Cup assist — an African record. Canada's xG of 0.78 vs Morocco's 0.85 tells the story of a tight game the scoreline completely distorts. Alphonso Davies didn't play — his hamstring didn't feel right at training on Friday. Canada's greatest player missed their greatest game.`,
    excerpt3:`The model gave Morocco 69.5% — correct, the Elo gap of 147 points reflecting Morocco's genuine superiority even with Canada's +60 co-host boost applied. Morocco are into their second consecutive World Cup quarter-final on an unbeaten run of 33 matches. Canada exit having made the knockout stage for the first time, won their first-ever World Cup match against South Africa, and captured the imagination of a nation that never thought this was possible. The Canada story isn't over — it's just beginning.`,
    stat:`69.5%`, statLabel:`Morocco win prob`, stat2:`0–3`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: false,
  },  
  {
    tag:`Match Report`, date:`4 Jul 2026`,
    title:`Colombia 1–0 Ghana: Arias in the 14th. Díaz Denied Twice by Offside. Los Cafeteros Control Kansas City.`,
    excerpt:`Jhon Arias buried a cross to the far post in the 14th minute — a first-time cultured finish into the bottom corner after Luis Suárez, who had come on as an early substitute for the injured Jhon Córdoba, beat multiple defenders down the right wing before floating a perfect delivery. Colombia then controlled the match from that point forward with the quiet authority of a side that has been the most consistent in the tournament. Luis Díaz thought he had doubled it twice in the second half — both times correctly ruled out for offside by VAR — and Ghana's goalkeeper Ati-Zigi made seven saves to keep the margin at one.`,
    excerpt2:`Ghana's final contribution to this World Cup was zero shots on target across 90 minutes — their expected goals of 0.26 tells the story. Colombia dominated every statistical category and were unlucky not to win more convincingly. Queiroz brought on fresh legs throughout the second half but Ghana never threatened to level. Colombia's defensive organisation, marshalled superbly by Dávinson Sánchez and Yerry Mina, was imperious. The sweltering Kansas City heat was the only opponent that gave Colombia any real difficulty all evening.`,
    excerpt3:`The model gave Colombia 74.0% — correct. Colombia advance to the round of 16 for the third time in their history, where they face Switzerland in Vancouver on July 7. Ghana exit without a shot on target in the entire match — a painful end for a side that produced the tournament's greatest goalkeeping performance from Ati-Zigi against Colombia in the group stage. The turnaround in 10 days was stark. Switzerland vs Colombia on Tuesday is the tie that nobody is talking about and everyone should be watching.`,
    stat:`74.0%`, statLabel:`Colombia win prob`, stat2:`1–0`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: false,
  },
  {
    tag:`Match Report`, date:`3 Jul 2026`,
    title:`Argentina 3–2 Cabo Verde (AET): Messi 19 and 20. Vozinha Heroic. The Closest Argentina Have Ever Come to Exit.`,
    excerpt:`Messi opened in the 29th minute — his 19th World Cup goal, a composed finish after Mac Allister's through ball. Cape Verde's Deroy Duarte levelled in the second half with a shot that deflected past Martínez, sending the Miami crowd into raptures. In extra time, Lisandro Martínez headed Argentina back in front from a corner — and then Sidny Lopes Cabral tied it again in the 103rd minute.  Cape Verde had forced Argentina into extra time and then equalised in it. The smallest nation in World Cup history were 17 minutes from the greatest upset in World Cup history.`,
    excerpt2:`What followed was chaos. A Messi free kick deflected off the wall, then off Vozinha's leg, and crossed the line — initially given as a Cristian Romero goal before VAR changed it to a Cabo Verde own goal. 3–2. Cape Verde pushed desperately for another equaliser. Vozinha, 40 years old, who had kept a clean sheet against Spain and Saudi Arabia in the group stage, had made nine saves by the time the final whistle blew. He received a standing ovation from every neutral in the stadium. Messi extended his all-time World Cup scoring record to 20 goals  — his seventh goal in four games at this tournament.`,
    excerpt3:`The model gave Argentina 78.3% — correct, though the margin of victory flattered the defending champions completely. Cabo Verde were 17 minutes from one of sport's greatest moments. Vozinha was magnificent. The Blue Sharks captured the imagination of a global audience throughout this tournament — their three group stage clean sheets, Cabo Verde 0–0 Spain, the remarkable defensive performances — and they leave with heads held high and a country that will feel this for years. Argentina face Egypt in Atlanta on July 7. Messi has 20 World Cup goals. The record is his alone. Egypt should be terrified.`,
    stat:`78.3%`, statLabel:`Argentina win prob`, stat2:`3–2 AET`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: true,
  },  
  {
    tag:`Match Report`, date:`3 Jul 2026`,
    title:`Australia 1–1 Egypt (2–4 pens): Salah's Panenka. Souttar and Herrington Miss. Egypt Into the Last 16.`,
    excerpt:`Emam Ashour headed Egypt in front in the 13th minute from a set piece — Australia's defensive shape failing to account for his run at the near post. Cristian Volpato had already hit the crossbar with a 25-yard drive that threatened to define the game differently. Australia kept pressing and were rewarded in the 55th minute when Mohamed Hany turned a dangerous free-kick delivery into his own net — a cruel deflection that gave Patrick Beach a lead his country felt they deserved. 1–1, the game they needed.`,
    excerpt2:`Extra time produced chances at both ends. Salah, quiet for much of the 90 minutes, came alive in the additional period — twice testing Beach, once forcing Harry Souttar into a goal-line clearance that was breathtaking in its desperation. Tony Popovic made the bold call to bring on Mat Ryan for the shootout, replacing Beach specifically for penalties. It didn't work. Souttar blazed the first penalty over the bar. Ryan saved nothing. Salah stepped up and chipped an audacious Panenka down the centre. 18-year-old Herrington, Australia's fourth penalty taker, hit the bar. Hossam Abdelmaguid converted the winner. Egypt through.`,
    excerpt3:`The model gave Australia 71.3% — wrong, and one of the tournament's most significant upsets. Egypt record their first ever World Cup knockout victory — the Pharaohs advanced to their first-ever World Cup round of 16  where they face either Argentina or Cabo Verde. Australia exit having produced arguably the tournament's bravest defensive performance in extra time, only to be let down by two missed penalties. Salah's Panenka will be replayed forever. Souttar's miss will haunt him almost as long.`,
    stat:`71.3%`, statLabel:`Australia win prob`, stat2:`1–1 (2–4 pens)`, statLabel2:`Final score`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: true,
  },
  {
    tag:`Match Report`, date:`3 Jul 2026`,
  ...
  },  
  {
    ...
    excerpt2:`Extra time was frantic. Senegal pushed for the winner — Mbaye and Ndiaye both close — but a controversial penalty was awarded to Belgium in the dying embers of extra time and Tielemans drilled it past Diaw  for 3–2. Belgium coach Rudi Garcia was given a yellow card in the chaos on the touchline  as Senegal protested furiously. The penalty decision will be debated for weeks. Replays showed minimal contact. The referee pointed to the spot. Tielemans converted with ice in his veins and Belgium were through.`,
    excerpt3:`The model gave Belgium 80.5% — correct outcome, but the model's insight revealing only a 16-point Elo gap while projecting xG of 1.95 vs 0.65 showed a real contradiction. The Elo was right — this was never as one-sided as the xG suggested. Belgium face either USA or Bosnia-Herzegovina in the Round of 16.  Senegal exit having led with three minutes to go in normal time. A heartbreaking conclusion to a tournament where they beat Iraq 5–0, ran France close, and deserved far more than a controversial extra-time penalty ended their journey.`,
    stat:`80.5%`, statLabel:`Belgium win prob`, stat2:`3–2 AET`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: true,
  },  
  {
    tag:`Match Report`, date:`1 Jul 2026`,
    title:`England 2–1 DR Congo: Kane's Brace Rescues the Three Lions. Mpasi the Performance of the Tournament.`,
    excerpt:`Brian Cipenga scored in the seventh minute  — a magnificent diagonal from Mbemba, Cipenga controlling and slamming low past Pickford at the near post — and for long stretches England looked exactly like the side that drew with Ghana and couldn't break down Panama without Bellingham's individual brilliance. Yoane Wissa hit the post just before half time and Kane controversially had a penalty kick appeal waved away.  DR Congo were magnificent. Mpasi-Nzau made several stunning saves  — denying Bellingham, denying Kane from close range, commanding his area with the same authority that made him the standout performer against Colombia in the group stage.`,
    excerpt2:`Tuchel passionately drilled his team during the second half break  and the changes told. Gordon came on and transformed everything. Good work down the right saw Rice find Anthony Gordon on the other side of the box, and his chipped cross was met by Kane to level the scoreline  in the 75th minute. Then the 86th: Kane received the ball on the edge of the box and smartly made space to unleash a fierce drive into the roof of the net.  His 12th and 13th World Cup goals. England's all-time top scorer at World Cups.  Wissa's free-kick over the bar ended a performance from DR Congo that deserved far more.`,
  ...
  },  
  {
    ...
    excerpt2:`Issa Diop rose brilliantly in the 90th+1st minute to meet a Chemsdine Talbi cross and power a header level  — Dutch hearts broken in stoppage time, Moroccan ones soaring. Extra time settled nothing. Then penalties: Timber and Kluivert missed for the Dutch, Hakimi and El Aynaoui missed for Morocco too — a shootout of nerves and misses on both sides — before Yassine Bounou produced a crucial save from Summerville,  and Ismael Saibari stepped up to send Morocco through.`,
    excerpt3:`The model favoured Netherlands before kick-off — wrong, in the cruellest possible fashion. Morocco face co-hosts Canada in the Round of 16 in Houston on July 4.  The AFCON champions and Arab Cup winners continue to be the story of this tournament — a side that drew with Brazil, beat Scotland and Haiti, and have now knocked out Netherlands on penalties. The Dutch wait for a first World Cup win continues. It will continue until at least 2030.`, 
    stat:`55.9%`, statLabel:`Netherlands win prob`, stat2:`1–1`, statLabel2:`Final score (2–3 pens)`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: true,
  },
  {
    tag:`Match Report`, date:`29 Jun 2026`,
    title:`Germany 1–1 Paraguay (3–4 pens): The Biggest Shock of the Tournament. Four-Time Champions Out.`,
    excerpt:`Germany had 78% of the possession in the first half  and somehow trailed. Julio Enciso scored on a header late in the first half  to give Paraguay — third-placed finishers in Group D, beaten 4-1 by USA in their opener — a lead that defied every pre-match projection. Kai Havertz equalised in the 52nd minute  and for long stretches Germany looked like they would eventually find a way through Paraguay's compact 4-5-1.`,
    excerpt2:`Jonathan Tah thought he had the winner in extra time, heading in a corner in the 102nd minute, but officials ruled the goal out after Waldemar Anton was judged to have pushed goalkeeper Orlando Gill to the ground before the shot.  Klopp called the decision wrong.  Penalties followed. Havertz had his spot-kick saved, Tah blasted his over the bar in the first round of sudden death,  and José Canale — not in the starting lineup for either of his previous two appearances — stepped up and scored the winner.  Paraguay became the first team ever to beat Germany in a World Cup penalty shootout.`, 
    excerpt3:`The model heavily favoured Germany — wrong, in the biggest upset of the tournament. Germany suffered another early World Cup exit, continuing a troubling pattern for Julian Nagelsmann's side.  Paraguay reached the knockout stage having opened with a 4-1 loss to USA, then beaten Turkey while down to 10 men for an entire half, then drawn 0-0 with Australia  — an unlikely path to one of the great World Cup shocks. Four-time champions. Beaten on penalties by a side many had written off after matchday one.`,
    stat:`74.62%`, statLabel:`Germany win prob`, stat2:`1–1`, statLabel2:`Final score (3–4 pens)`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: true,
  },
  {
    tag:`Match Report`, date:`29 Jun 2026`,
  ...
  },  
  {
    ...
    excerpt2:`Algeria hit the right post with a would-be goal from Fares Chaibi  that would have made it 4–3 in the closing minutes. Algeria's Gouiri and Belghali were magnificent — the two substitutes from the Jordan win carrying their form into the biggest match of their lives. Austria's Sabitzer was the game's best player across 90 minutes. Six bookings. Two red card reviews by VAR. The referee worked harder than anyone on the pitch. Iran, watching from their hotel in Vancouver, were eliminated when the final whistle blew. They exit with the cruelest of eliminations — a VAR-disallowed winner against Egypt and now this.`,
    excerpt3:`The model gave Austria 40.7% — wrong, in a three-way split that couldn't begin to predict a 3–3 draw. Both Algeria and Austria advance to the Round of 32.  Algeria face Switzerland. Austria face Spain. Two completely different tests. Iran's World Cup ruin is over  — they exit having deserved far more than they got. Group J is done. The knockout stage begins tomorrow.`,
    stat:`40.7%`, statLabel:`Austria win prob`, stat2:`3–3`, statLabel2:`Final score`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: true,
  },
  {
    tag:`Match Report`, date:`27 Jun 2026`,
    title:`Argentina 3–1 Jordan: Messi Off the Bench. Six Goals in the Tournament. The Record Hunt Continues.`,
    excerpt:`Lionel Messi came off the bench to score in a seventh consecutive World Cup game, a new record. He has six goals during this edition of the World Cup.  Argentina were already 2–1 up when he entered — Lautaro Martínez and Giovani Lo Celso both scoring their first World Cup goals for the defending champions. Jordan pulled one back through Mousa Tamari, who beat the goalkeeper with a low accurate shot into the bottom left corner  — a moment of genuine quality from a side that has competed well despite being eliminated. Then Messi arrived, the crowd found another level, and he delivered.`,
    excerpt2:`Argentina finished the group stage with a perfect nine points from three matches  — three wins, nine goals scored, two conceded. Scaloni rotated heavily — Lo Celso, Correa, Mac Allister all started — but the quality never dropped. Just Fontaine's record of 13 World Cup goals may feel unattainable, but if anyone can catch him, it's Messi,  who has scored six in three games at 37 years old. The thought of watching him through four more knockout games with that pace of scoring is extraordinary.`,
    excerpt3:`The model gave Argentina 61.1% — correct. Argentina finish top of Group J and will face Cabo Verde in the Round of 32 in Miami  — where Messi plays his club football for Inter Miami. The symmetry is almost too perfect. Jordan exit having scored five goals in three matches — more than anyone expected from a side in their first-ever World Cup. A tournament to remember for the Blue Wave.`,
    stat:`61.1%`, statLabel:`Argentina win prob`, stat2:`3–1`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: false,
  },
  {
    tag:`Match Report`, date:`27 Jun 2026`,
    title:`DR Congo 3–1 Uzbekistan: The Leopards Roar. Wissa Inspires a Comeback. Congo Make History.`,
    excerpt:`DR Congo completed a 3–1 comeback against Uzbekistan and secured passage to the knockout rounds as one of the best third-placed teams.  Yoane Wissa, who had been one of the tournament's most dangerous attackers whenever he touched the ball, added to his tally  in a second half that turned the game completely on its head. Uzbekistan — in their first ever World Cup — took the lead and briefly dared to dream before Congo's quality asserted itself ruthlessly.`,
    excerpt2:`The Leopards needed to win and win with goals to secure a third-place spot. They delivered. Three goals, the crowd in Atlanta fully behind the Congolese supporters who had been on an extraordinary journey. Goalkeeper Lionel Mpasi-Nzau — who had been magnificent against Colombia in matchday two — this time had a quieter afternoon as Congo's attackers took centre stage. Uzbekistan's solitary goal was consolation from a side that exceeded every pre-tournament expectation. Fabio Cannavaro's side deserved more from this tournament.`,
    excerpt3:`The model gave Uzbekistan 38.1% — wrong. The model had Uzbekistan as the most likely winner in a near coin-flip, which tells you everything about how open this fixture looked on paper. DR Congo locked up a spot in the Round of 32 as one of the best third-placed teams  and will now face England in Atlanta — a reunion with a stadium that saw them make history. Uzbekistan exit having scored in all three group games and beaten no one. Their first World Cup was an education. The second will be different.`,
    stat:`38.1%`, statLabel:`Uzbekistan win prob`, stat2:`3–1`, statLabel2:`Final score`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: false,
  },
  {
    tag:`Match Report`, date:`27 Jun 2026`,
    title:`Colombia 0–0 Portugal: The Draw That Suited Everyone. Ronaldo Peripheral. Colombia Top Group K.`,
    excerpt:`Portugal couldn't do much of anything against Colombia in a tepid 0-0 Group K battle.  Both teams needed a draw to advance — Colombia to confirm top spot, Portugal to confirm second — and for long stretches this looked exactly like two sides who knew the mathematics and played accordingly. There were 24 shots in the first half, 15 of them Colombia's,  which at least suggested one team was trying. Luis Díaz was electric. James Rodríguez pulled strings in midfield. Portugal, though, were passive and Ronaldo was barely involved.`,
    excerpt2:`Connelly writing for ESPN said Portugal have a Ronaldo problem again after the draw.  He came off in the 70th minute to polite applause. The question hanging over his tournament — can he still be the difference at this level? — remains unanswered after three group games that produced five goals and one draw. Colombia's 0-0 performance was professional, controlled and tactically correct. They didn't need to win. They didn't try to win. They finish top of Group K with seven points.`,
    excerpt3:`The model gave Colombia 51.3% — technically wrong (draw not win) but Colombia achieved what the model wanted — group winners. Colombia face Ghana in the next round, Portugal get Croatia, and DR Congo face England.  Colombia's R32 tie looks very manageable. Portugal vs Croatia is a fascinating knockout fixture — two European sides with very different styles who last met in the 2022 quarter-finals. Group K produced nine goals, one world-class goalkeeper display, a Ronaldo record and a very boring final match. The knockout rounds will sharpen minds considerably.`,
    stat:`51.3%`, statLabel:`Colombia win prob`, stat2:`0–0`, statLabel2:`Final score`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: false,
  },  
  {
    tag:`Match Report`, date:`27 Jun 2026`,
  ...
  },  
  {
    ...
    excerpt2:`New Zealand pulled one back through Elijah Just — his fourth goal of the tournament, an extraordinary return for a side ranked 86th in the world — but it was a consolation. Belgium's third, fourth and fifth goals came with increasing ease as New Zealand's legs went in the second half. The result, combined with Egypt vs Iran finishing 1–1, confirmed Belgium in second place in Group G,  setting up a Round of 32 tie. The All Whites exit with heads held high — four goals scored, more than anyone expected.`,
    excerpt3:`The model gave Belgium 54.1% — correct. Group G final standings: Egypt top on five points, Belgium through in second on five points on goal difference, Iran eliminated despite Khalilzadeh's stoppage-time winner being overturned by VAR, New Zealand eliminated.  Belgium's R32 tie: against Colombia's group opponents. The Golden Generation are long gone but this Belgium side — Garcia's Belgium — have found something here. Five goals in the final group game is a statement.`,
    stat:`54.1%`, statLabel:`Belgium win prob`, stat2:`1–5`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: false,
  },
  {
    tag:`Match Report`, date:`26 Jun 2026`,
    title:`Egypt 1–1 Iran: VAR Takes Iran's Winner Away. Heartbreak in Seattle. Egypt Through as Group Winners.`,
    excerpt:`Iran got to celebrate a stoppage-time winner — then it got taken back.  Shoja Khalilzadeh bundled home in the 93rd minute and the Iranian bench erupted. VAR reviewed for three minutes. The goal was disallowed — offside in the build-up, the tightest of calls. Several Iranian players were collapsed or crying on the field still in disbelief.  Egypt went through as group winners. Iran's World Cup ended not with a defeat, not even with a draw, but with a disallowed goal that will haunt their players for years.`,
    excerpt2:`The match itself was genuinely dramatic. Egypt took the lead through a Salah assist converted by Omar Marmoush. Iran equalised before half time through Taremi, who has been their standout performer throughout the group stage. Both sides had chances in the second half — Iran hit the crossbar in the 88th minute before the agony of the disallowed winner. Salah was less influential than in previous games but his creative presence restructured Iran's defensive shape for the entire 90 minutes.`,
    excerpt3:`The model predicted Iran at 38.2% — barely a majority over Egypt's 38.0% in what was essentially a coin flip three ways. Wrong on the outcome. Group G final: Egypt through as group winners on five points, Belgium through in second on five points, Iran eliminated, New Zealand eliminated.  Iran leave having created more xG than any eliminated side in this tournament. The VAR decision will be debated for years. Was it the right call? Technically yes. Was it fair? That's a different question entirely.`,
    stat:`38.2%`, statLabel:`Iran win prob`, stat2:`1–1`, statLabel2:`Final score`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: false,
  },
  {
    tag:`Match Report`, date:`26 Jun 2026`,
    title:`Cabo Verde 0–0 Saudi Arabia: Vozinha Again. The Blue Sharks Are Through. The Dream Continues.`,
    excerpt:`Seconds after the final whistle, Cabo Verde players huddled around a phone waiting for Spain's win over Uruguay to go final.  When it did, the dream became real. Cabo Verde — who drew with Spain 0–0 on matchday one and backed it up with a goalless draw against Saudi Arabia — advance to the Round of 32 as group runners-up on points. Vozinha, 40 years old, the oldest goalkeeper at this World Cup, kept his third clean sheet of the tournament.  The stadium rang to Cape Verdean songs. Something genuinely wonderful is happening.`,
    excerpt2:`Saudi Arabia needed a win. They pressed, they created, they found Vozinha immovable. Al-Dawsari had two chances in the second half that a goalkeeper ten years younger might have conceded. Firas Al-Buraikan hit the post in the 78th minute. Vozinha saved from Talal Al-Bahbri at point-blank range in stoppage time. Saudi Arabia are eliminated. Cabo Verde go through. Their R32 opponents: Lionel Messi and Argentina.  Somehow, the Cape Verdean players looked like they were delighted by this news rather than terrified.`,
    excerpt3:`The model gave Cabo Verde 41.7% — the highest single probability but wrong on the specific draw outcome. Cabo Verde are the third-smallest nation ever to qualify for a World Cup  and they have not conceded a single goal in two of their three group games. Vozinha. What a player. What a story. Whatever happens against Argentina, this tournament will remember the Blue Sharks and their 40-year-old goalkeeper who stopped Spain, beat Switzerland and saw off Saudi Arabia.`,
    stat:`41.7%`, statLabel:`Cabo Verde win prob`, stat2:`0–0`, statLabel2:`Final score`, stat3:`✗`, statLabel3:`Model incorrect`,
    modelCorrect: false, highlight: false,
  },
  {
    tag:`Match Report`, date:`26 Jun 2026`,
    title:`Uruguay 0–1 Spain: Yamal Seals It. La Roja Top Group H. Uruguay Eliminated.`,
    excerpt:`Spain defeated Uruguay 1-0 and Uruguay, a two-time World Cup winner, will not advance to the knockout rounds.  Lamine Yamal, fit again after missing the Cabo Verde draw on matchday one, scored the only goal in the second half — a low finish from the edge of the box that gave Muslera no chance. Bielsa stood on the touchline watching his side's tournament end without a win. Darwin Núñez pressed relentlessly for a late equaliser that never came.`,
    excerpt2:`Uruguay had the better of the first half — Valverde hit the post in the 23rd minute, Núñez was denied by an outstanding Unai Simón save in the 38th. La Celeste played their best football of the tournament in a game where they needed a win. Spain were disciplined and dangerous on the counter, Pedri and Gavi controlling the tempo once they went ahead. Yamal's goal — his second of the tournament — was the decisive moment in a match that ebbed and flowed before Spain's class told.`,
    excerpt3:`The model gave Spain 50.8% — correct. Spain top Group H with seven points. Cabo Verde also advance in second place after their draw with Saudi Arabia.  Uruguay's exit is one of the tournament's genuine shocks — a side with Valverde, Núñez, and Giménez going out in the group stage having not won a single match. Bielsa's defensive system, so effective in qualifying, couldn't generate enough attacking quality when the pressure was highest. Two-time champions. Eliminated. The World Cup can be cruel.`,
    stat:`50.8%`, statLabel:`Spain win prob`, stat2:`0–1`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: false,
  },
  {
    tag:`Match Report`, date:`26 Jun 2026`,
    title:`Senegal 5–0 Iraq: Mané Masterclass. Five Goals. Senegal Through as Third-Placed Team.`,
    excerpt:`Iraq received a red card in the 13th minute, which meant Senegal played the majority of the game with a man advantage. Senegal scored four unanswered goals from that point onward.  Sadio Mané, who had been quiet in the opening two games, was magnificent — a goal and two assists, the old pace and movement back with a vengeance. Papa Gueye opened the scoring before the red card, then Mané took over and Iraq had no answer for Senegal's relentless pressing with an extra man.`,
    excerpt2:`Five goals, clean sheet, and a performance that finally showed what Aliou Cissé's side are capable of. Ndiaye, Sarr and Diatta all scored as Senegal ran riot in the second half. Iraq coach Graham Arnold said after the game that everyone in Iraq should be proud of the fact that they made it here and performed well in two of three games.  A generous assessment but not an unfair one — they were competitive against France and Norway before this collapse.`,
    excerpt3:`The model gave Senegal 73.2% — correct, though the red card transformed a competitive match into a rout. Senegal advance to the Round of 32 as a third-placed team — their five goals and positive goal difference make them almost certain to qualify as one of the eight best third-placed sides.  Their R32 opponents will depend on the full third-place standings. Mané reminded everyone tonight what he is capable of. At 34, he still has one more knockout round in him.`,
    stat:`73.2%`, statLabel:`Senegal win prob`, stat2:`5–0`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: false,
  },
  {
    tag:`Match Report`, date:`26 Jun 2026`,
    title:`Norway 1–4 France: Dembélé Hat-Trick. Haaland Benched. France Win Group I in Style.`,
    excerpt:`The highly anticipated Group I matchup between Kylian Mbappé and Erling Haaland was a bit of a letdown as the latter stayed on the bench.  Norway manager called it a 'no-brainer' to rest Haaland.  France didn't need anyone special — they had Ousmane Dembélé. Dembélé scored the second-fastest hat-trick in World Cup history  in a performance of such speed and directness that Norway's defence simply couldn't cope. Both teams were already through — Norway needed the win only for group position. France needed to win only to top the group. France won. France top.`,
    excerpt2:`Dembélé's three goals came with increasing quality — a tap-in, a curling finish, then a low drive that Nyland barely saw. Mbappé was involved in each, pulling defenders left so Dembélé could attack right. Norway pulled one back through their substitute — Désiré Doué headed in a late goal for France  to make it four. The final scoreline was flattering for France but an accurate reflection of the gap between a side playing its best football and one managing a comfortable passage.`,
    excerpt3:`The model gave France 41.7% — correct, though 4–1 exceeded any pre-match projection. France top Group I and will face the Group J runner-up in the R32. Norway through in second, facing the Group J winner. Group I final: France 9 points, Norway 6, Senegal 3 (advancing as third), Iraq 0 eliminated.  Dembélé has now scored four goals in three games. The Ballon d'Or 2025 winner is playing like it.`,
    stat:`41.7%`, statLabel:`France win prob`, stat2:`1–4`, statLabel2:`Final score`, stat3:`✓`, statLabel3:`Model correct`,
    modelCorrect: true, highlight: true,
  },  
  {
    tag:`Match Report`, date:`26 Jun 2026`,
