export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.edgeanalysts.com/insights',
  ...
  alternates: { canonical: 'https://www.edgeanalysts.com/insights' },
};

const articlesJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Blog',
  '@id': 'https://www.edgeanalysts.com/insights',
  ...
  blogPost: [
    {
      '@type': 'BlogPosting',
      '@id': 'https://www.edgeanalysts.com/insights#spain-win-probability',
      ...
      url: 'https://www.edgeanalysts.com/insights#spain-win-probability',
      keywords: 'Spain World Cup 2026, WC 2026 predictions, tournament win probability',
    },
    {
      '@type': 'BlogPosting',
      '@id': 'https://www.edgeanalysts.com/insights#colombia-value',
      ...
      dateModified: '2026-06-23',
      author: { '@type': 'Organization', name: 'Edge Analysts' },
      url: 'https://www.edgeanalysts.com/insights#colombia-value',
      keywords: 'Colombia World Cup 2026, WC 2026 value bet, expected value betting',
    },
    {
      '@type': 'BlogPosting',
      '@id': 'https://www.edgeanalysts.com/insights#group-i-analysis',
      ...
      dateModified: '2026-06-23',
      author: { '@type': 'Organization', name: 'Edge Analysts' },
      url: 'https://www.edgeanalysts.com/insights#group-i-analysis',
      keywords: 'World Cup 2026 Group I, France WC 2026, Norway World Cup 2026',
    },
    {
      '@type': 'BlogPosting',
      '@id': 'https://www.edgeanalysts.com/insights#norway-mispriced',
      ...
      dateModified: '2026-06-23',
      author: { '@type': 'Organization', name: 'Edge Analysts' },
      url: 'https://www.edgeanalysts.com/insights#norway-mispriced',
      keywords: 'Norway World Cup 2026, Haaland World Cup, WC 2026 dark horse',
    },
    {
      '@type': 'BlogPosting',
      '@id': 'https://www.edgeanalysts.com/insights#edgeiq-model-methodology',
      ...
      dateModified: '2026-06-23',
      author: { '@type': 'Organization', name: 'Edge Analysts' },
      url: 'https://www.edgeanalysts.com/insights#edgeiq-model-methodology',
      keywords: 'football prediction model, Elo rating football, World Cup 2026 model methodology',
    },
    {
      '@type': 'BlogPosting',
      '@id': 'https://www.edgeanalysts.com/insights#group-h-deep-dive',
      ...
      dateModified: '2026-06-23',
      author: { '@type': 'Organization', name: 'Edge Analysts' },
      url: 'https://www.edgeanalysts.com/insights#group-h-deep-dive',
